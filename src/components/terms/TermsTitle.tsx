...
const TermsTitle: React.FC = () => {
  ...
  return (
    <div className='mx-auto max-w-screen-xl pt-[60px] sm:pt-[1.875rem] sm:px-5'>
        <div className='flex flex-wrap items-center gap-[10px] font-medium '>
            <Link to='/'>
        ...
        <div className='pt-[3.75rem] flex justify-center sm:pt-[1.875rem]'>
            <div className='text-left w-[65%] sm:w-full'>
                ...
                <h3 className='font-medium text-[20px] leading-[30px] text-[#0072BB] mt-[50px] sm:mt-5'>
                    {t('pages.termsSubtitle1')}
                </h3>
                <p className='mt-[10px] font-light text-[#677E8B] sm:mt-[6px]'>
                    {t('terms.1')} <br />
                    {t('terms.1.1')} <br />
                    {t('terms.1.2')} <br />
                    {t('terms.1.3')} <br />
