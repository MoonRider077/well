          ...
          return (
            <div key={card.id} className={`${colSpanClass} ${borderRadiusClass} ${borderClass} sm:flex-col-reverse flex items-center sm:items-start text-nowrap p-5 col-span-12 border border-[#F0F2F6]`}>
              <div>
                ...
                <button className='bg-[#F7F8FA] sm:mt-4 mt-[1.875rem] py-[0.8rem] px-[3.5rem] border-none rounded-[50px] hover:text-[#FFFFFF] hover:bg-[#0072BB] transition duration-300 ease-in-out'>
                  {t('buttons.add')}
                </button>
              </div>
