    ...
    >
      ...
      <footer className="absolute bg-[#F7F8FA] bottom-0 flex sm:block justify-between sm:p-5 py-6 px-10 w-full">
        ...
        <div className="sm:flex sm:justify-center">
          <button className="sm:mt-5 py-4 px-[5.625rem] bg-[#0072BB] text-white outline-none rounded-[50px] border border-solid font-medium hover:bg-white hover:text-[#0072BB] border-[#0072BB]">
            {t("cart.confirmOrder")}
          </button>
        </div>
      </footer>
